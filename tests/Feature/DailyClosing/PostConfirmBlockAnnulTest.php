...
class PostConfirmBlockAnnulTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_annulment_rejected_after_closure_confirmed(): void
    {
        ...
        $this->post(route('operations.annul', $operation), [
            'reason' => 'Intento de anulación post confirmación',
        ]);
    ...
    public function test_admin_cannot_annul_after_closure_confirmed(): void
    {
        $operation = Operation::create([
            'organization_id' => $this->org->id, 'store_id' => $this->agent->store_id,
            'bank_agent_id' => $this->agent->id, 'operation_type_id' => $this->type->id,
        ...
        $this->post(route('operations.annul', $operation), [
            'reason' => 'Anulación por admin post confirmación',
        ]);
