...
class ReopenNoReasonTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_reopen_without_reason_is_rejected(): void
    {
        Operation::create([
    ...
    public function test_reopen_with_long_reason_is_rejected(): void
    {
        Operation::create([
            'organization_id' => $this->org->id, 'store_id' => $this->agent->store_id,
            'bank_agent_id' => $this->agent->id, 'operation_type_id' => $this->type->id,
