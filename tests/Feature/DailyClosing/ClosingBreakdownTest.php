...
class ClosingBreakdownTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_breakdown_by_type_is_correct(): void
    {
        Operation::create([
        ...
        Operation::create([
            ...
            'user_id' => $this->operator->id, 'amount' => 50.00, 'currency' => 'PEN',
    ...
    public function test_breakdown_by_operator_is_correct(): void
    {
        Operation::create([
            'organization_id' => $this->org->id, 'store_id' => $this->agent->store_id,
            'bank_agent_id' => $this->agent->id, 'operation_type_id' => $this->typeEntrada->id,
        ...
        Operation::create([
            'organization_id' => $this->org->id, 'store_id' => $this->agent->store_id,
            'bank_agent_id' => $this->agent->id, 'operation_type_id' => $this->typeEntrada->id,
            'user_id' => $this->operator->id, 'amount' => 80.00, 'currency' => 'PEN',
            'effective_at' => $this->businessDate . ' 11:00:00', 'recorded_at' => now(),
            'status' => Operation::STATUS_ACTIVE,
            'idempotency_key' => \Illuminate\Support\Str::random(64),
            'created_at' => now(), 'updated_at' => now(),
        ...
        $response = $this->get(route('daily-closures.show', $closure));
        $response->assertOk();
        $response->assertSee($this->admin->username_normalized);
        $response->assertSee($this->operator->username_normalized);
    }
}
