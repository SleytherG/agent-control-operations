...
class PostConfirmBlockRegisterTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_register_operation_rejected_in_confirmed_date(): void
    {
        Operation::create([
        ...
        $idempotencyKey = \Illuminate\Support\Str::random(64);
        ...
        $this->post(route('operations.store'), [
            ...
            'amount' => 200.00,
            'currency' => 'PEN',
            'effective_at' => $this->businessDate . ' 12:00:00',
    ...
    public function test_register_operation_allowed_on_different_date_same_agent(): void
    {
        Operation::create([
            'organization_id' => $this->org->id, 'store_id' => $this->agent->store_id,
            'bank_agent_id' => $this->agent->id, 'operation_type_id' => $this->type->id,
