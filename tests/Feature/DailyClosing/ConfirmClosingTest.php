...
class ConfirmClosingTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_admin_can_confirm_active_closure(): void
    {
        Operation::create([
        ...
        $closure->refresh();
        $this->assertEquals(DailyClosure::STATUS_CONFIRMADO, $closure->status);
        $this->assertNotNull($closure->confirmed_by);
        $this->assertNotNull($closure->confirmed_at);
        $this->assertEquals($this->admin->id, $closure->confirmed_by);
    }

    public function test_confirm_records_audit_log(): void
    {
        Operation::create([
            'organization_id' => $this->org->id, 'store_id' => $this->agent->store_id,
            'bank_agent_id' => $this->agent->id, 'operation_type_id' => $this->type->id,
        ...
        $auditLog = AuditLog::where('action', 'daily_closure.confirmed')
    ...
    public function test_cannot_confirm_already_confirmed_closure(): void
    {
        Operation::create([
            'organization_id' => $this->org->id, 'store_id' => $this->agent->store_id,
            'bank_agent_id' => $this->agent->id, 'operation_type_id' => $this->type->id,
