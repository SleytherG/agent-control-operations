...
class NoPendingConfirmTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_no_warning_when_no_pending_confirm(): void
    {
        Operation::create([
        ...
        $response->assertOk();
        $response->assertDontSee('Pendiente de confirmación');
        $response->assertDontSee('Atención');
    }
}
