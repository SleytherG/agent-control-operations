...
class OperationUserImmutabilityTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_user_id_is_always_auth_user(): void
    {
        ...
        $this->assertNotEquals($this->otherUser->id, $operation->user_id);
    }
}
