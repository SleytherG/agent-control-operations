...
class OperationAnnulmentTest extends TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->operation = Operation::create([
            ...
            'effective_at' => now()->subHours(1), 'recorded_at' => now()->subHours(1),
            'status' => 'ACTIVE', 'idempotency_key' => hash('sha256', 'annul-test-1'),
            'created_at' => now()->subHours(1), 'updated_at' => now()->subHours(1),
        ]);
    }

    public function test_operator_can_annul_own_operation_within_window(): void
    {
        ...
        $this->assertDatabaseHas('operations', [
            ...
            'status' => 'ANNULLED',
            'annulled_by' => $this->operator->id,
            'annulment_reason' => 'Error en el registro',
        ]);
    }
}
