...
class OperationAnnulmentWindowTest extends TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        UserBankAgentAssignment::create([
            ...
            'assigned_by' => $admin->id, 'assigned_at' => now()->subHours(25),
            'is_active' => true, 'created_at' => now()->subHours(25), 'updated_at' => now(),
        ]);
        ...
        $this->operation = Operation::create([
            ...
            'user_id' => $this->operator->id, 'amount' => 150.00, 'currency' => 'PEN',
            'effective_at' => now()->subHours(25), 'recorded_at' => now()->subHours(25),
            'status' => 'ACTIVE', 'idempotency_key' => hash('sha256', 'window-test'),
            'created_at' => now()->subHours(25), 'updated_at' => now()->subHours(25),
        ]);
    }

    public function test_operator_cannot_annul_beyond_window(): void
    {
