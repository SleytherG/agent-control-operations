...
class OperationAgentAssignmentTest extends TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $store1 = Store::create(['organization_id' => $this->org->id, 'district_id' => $district->id, 'code' => 'ST-001', 'name' => 'Store 1', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()]);
        $store2 = Store::create(['organization_id' => $this->org->id, 'district_id' => $district->id, 'code' => 'ST-002', 'name' => 'Store 2', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()]);
        $bank = Bank::create(['organization_id' => $this->org->id, 'code' => 'BCP', 'name' => 'BCP', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()]);
        $this->assignedAgent = BankAgent::create(['organization_id' => $this->org->id, 'store_id' => $store1->id, 'bank_id' => $bank->id, 'code' => 'AG-001', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()]);
        $this->unassignedAgent = BankAgent::create(['organization_id' => $this->org->id, 'store_id' => $store2->id, 'bank_id' => $bank->id, 'code' => 'AG-002', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()]);
    ...
    public function test_operator_rejected_on_unassigned_agent(): void
    {
